                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="../server/register_admin.php" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="number" class="form-control form-control-user" placeholder="Nomor Telepon" name="telp" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="text-center small font-weight-bold">
                                Udah punya akun?
                                <a href="../login/petugas.php">Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
