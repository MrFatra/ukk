                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-800 mb-4 font-weight-bold">Buat Akun</h1>
                            </div>
                            <form class="user" action="../server/register_masyarakat.php" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control form-control-user" placeholder="NIK" name="nik" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="exampleInputEmail" placeholder="Nomor Telepon" name="telp" required>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="text-center small font-weight-bold">
                                Udah punya akun?
                                <a href="../login/masyarakat.php">Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
